...
const (
	BronesURL = "https://iam.ub.ac.id/auth/realms/ub/protocol/openid-connect/auth?client_id=siam&redirect_uri=https%%3A%%2F%%2Fsiam.ub.ac.id%%2Fmahasiswa&state=%s&response_mode=fragment&response_type=code&scope=openid&nonce=%s"
